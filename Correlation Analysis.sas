...
proc corr data=WORK.MYOCARD pearson nosimple noprob plots=none;
	var AGE SEX;
	with nr_11 nr_01 nr_02 nr_03 nr_04 nr_07 nr_08 np_01 np_04 np_05 np_07 np_08 
		np_09 np_10;
run;